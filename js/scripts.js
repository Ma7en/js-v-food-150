...
function initRestabook() {
    ...
    $('#res_date2').on('apply.daterangepicker', function (ev, picker) {
        $(this).val(picker.startDate.format('MM/DD/YYYY'));
    });
    $('#res_date2').on('cancel.daterangepicker', function (ev, picker) {
        $(this).val('');
    });
